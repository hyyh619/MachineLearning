...
#¸ù¾Ý²ÎÊý£¨±¾ÀýÓÐÁ½¸ö²ÎÊý£©µÄÈ¡Öµ·¶Î§ºÍ¾«¶ÈÒªÇó»ñµÃ»ùÒòµÄ¸öÊý
...
def getselectpair(cumsumrate):#ÓÃ×ªÅÌËã·¨¸ù¾ÝÀÛ»ý¸ÅÂÊÑ¡ÔñÁ½¸ö¸öÌå
...
sizepop = 50 #ÖÖÈº¹æÄ£
genermax = 100 #µü´ú´ÎÊý
ratecross = 0.70 #È¾É«Ìå½»ÅäÂÊ
ratemutation = 0.12 #»ùÒòÍ»±äÂÊ
...
while genermax > 0:
    ...
    fitnesslog.append([max(fitness), np.mean(fitness)])
    ...
    for i in range(0,sizepop,2):
        ...
        if rand2[0]<=ratecross:#½»²æ²Ù×÷£¬¶ÔÓ¦±äÁ¿1
        ...
        if rand2[1]<=ratecross:#½»²æ²Ù×÷£¬¶ÔÓ¦±äÁ¿2
